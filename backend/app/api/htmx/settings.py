"""HTMX routes for settings management (AI providers, colors, prompts)."""
...
from app.api.htmx.helpers import fetch_colors, fetch_sidebar_data
...
async def _render_providers_list(request: Request, db: AsyncSession, user_id: UUID) -> Response:
